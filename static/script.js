...
async function loadMolecules() {
    ...
    try {
        // используем параметры page и page_size вместо skip и limit
        ...
        // структура ответа: {molecules: [...], total: X, page: N, page_size: Y, total_pages: Z}
    ...
    try {
        ...
        if (response.ok) {
            if (data.found_count > 0) {
                // список с ID, названием и SMILES
